...
opts_chunk$set(fig.align='center', fig.show='hold',message=F,results='asis',dev='pdf',dev.args=list(family='serif'),fig.pos='!ht',warning=F)
...
<<echo = F, message = F>>=
mypath <- 'M:/docs/swmp_workshop_2014/training_modules/swmp_data/zip_ex'
